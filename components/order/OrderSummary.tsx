...
export default function OrderSummary() {
  ...
  const handleCreateOrder = async (formData: FormData) => {
    const data = {
      name: formData.get('name'), //Manera de recuperar el valor del formulario en next
      total,
      order
    }
    ...
    if(!result.success) {
      ...
      return//Detiene la ejecución del código en caso de que no pase la validación en el cliente 
    }
